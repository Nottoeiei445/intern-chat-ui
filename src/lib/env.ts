...
declare global {
  namespace NodeJS {
    interface ProcessEnv {
      ...
      NEXT_PUBLIC_VALLARIS_CONNECTION_ID: string;
      NEXT_PUBLIC_VALLARIS_ANALYTICS_KEY: string;
    }
  }
}
...
export const ENV = {
  ...
  VALLARIS_CONNECTION_ID: process.env.NEXT_PUBLIC_VALLARIS_CONNECTION_ID,
  VALLARIS_ANALYTICS_KEY: process.env.NEXT_PUBLIC_VALLARIS_ANALYTICS_KEY,
} as const;