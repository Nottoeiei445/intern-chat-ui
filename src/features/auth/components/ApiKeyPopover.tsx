    ...
    <div className="absolute bottom-[calc(100%+12px)] left-0 w-full z-50 animate-in slide-in-from-bottom-4 fade-in duration-300">
      ...
      <div className="relative">
        ...
        <button 
          ...
          className="absolute -top-3 -right-2 bg-slate-800 border border-slate-600 hover:bg-red-500 hover:border-red-500 text-slate-300 hover:text-white rounded-full p-1.5 shadow-xl z-50 transition-all scale-100 hover:scale-110 active:scale-90"
          title="Close"
        >
        ...
        <div className="bg-[#111]/95 backdrop-blur-xl border border-blue-500/30 rounded-2xl shadow-[0_-10px_40px_-15px_rgba(59,130,246,0.3)] p-4 flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] text-amber-400/80 flex items-center gap-1 hidden sm:flex">
