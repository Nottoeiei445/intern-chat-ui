...
export type MapMode = 'wms' | 'tms' | 'wmts' | 'vector_tile' | 'geojson' | 'vector'| 'coverage_tile' | 'pmtiles'; // vector เผื่อหลังบ้านส่งมาเฉยๆ ไม่บอกว่าเป็น vector_tile หรือ geojson
